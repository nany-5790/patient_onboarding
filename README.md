...
Setup
bashgit clone https://github.com/your_username/patient_onboarding.git
...
pythonfrom django.contrib.auth.models import User, Group
...
json{"id": "5e010a2a-46f3-427c-917a-96b49418e799", "status": "pending"}
Same idempotency_key — safe retry:
json{"id": "5e010a2a-46f3-427c-917a-96b49418e799", "status": "already_onboarded"}
...
Tests
bashpython manage.py test patients
Covers:
